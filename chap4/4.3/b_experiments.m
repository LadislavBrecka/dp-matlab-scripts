...
w_pos_real = w_pos_real(1, 1230+1500:1230+4000);
y_pos_real = y_pos_real(1, 1230+1500:1230+4000);
...
y_pos_real = y_pos_real(1, 1643+1500:1643+4000);
...
y_pos_real = y_pos_real(1, 1023+1500:1023+4000);
% plot(t_sim, w_pos_real); hold on;
...
y_pos_real = y_pos_real(1, 1564+1500:1564+4000);
% plot(t_sim, w_pos_real); hold on;
...
y_pos_real = y_pos_real(1, 1211+1500:1211+4000);
% plot(t_sim, w_pos_real); hold on;
...
xlabel('Čas [s]')
ylabel('Poloha [impl]')
title('Porovnanie rôznych hodnôt realatívneho tlmenia')