...
w_pos_real = w_pos_real(1, 1187+1500:1187+4000);
y_pos_real = y_pos_real(1, 1187+1500:1187+4000);
...
y_pos_real = y_pos_real(1, 1240+1500:1240+4000);
...
y_pos_real = y_pos_real(1, 1295+1500:1295+4000);
% plot(t_sim, w_pos_real); hold on;
...
y_pos_real = y_pos_real(1, 1083+1500:1083+4000);
% plot(t_sim, w_pos_real); hold on;
...
y_pos_real = y_pos_real(1, 952+1500:952+4000);
% plot(t_sim, w_pos_real); hold on;
...
y_pos_real = y_pos_real(1, 1173+1500:1173+4000);
% plot(t_sim, w_pos_real); hold on;
...
xlabel('Čas [s]')
ylabel('Poloha [impl]')
title('Porovnanie rôznych hodnôt reálneho pólu')